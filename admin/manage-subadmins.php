...
<html lang="en">
    <head>
        ...
        <title>UMPHub | Manage Subadmins</title>
...
<td><a href="edit-subadmin.php?said=<?php echo htmlentities($row['id']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
	&nbsp;<a href="manage-subadmins.php?rid=<?php echo htmlentities($row['id']);?>&&action=del"> <i class="fa fa-DEleted-o" style="color: #f05050"></i></a> </td>
</tr>
<?php
$cnt++;
 } ?>
