...
<html lang="en">
    <head>
        ...
        <title>UMPHub | Add Subadmin</title>
     ...
     <label for="password">Password</label>
      <input type="password" class="form-control" id="pwd" name="pwd" placeholder="Enter password" required>
       ...
       <label class="col-md-2 control-label">&nbsp;</label>
        <div class="col-md-10">
    <button type="submit" class="btn btn-custom waves-effect waves-light btn-md" style="background-color:#141738"; id="submit" name="submit">
       Submit</button>
                                                    </div>
                                                </div>
